...
<body>
	<form action="adminCourtTipOffRegist.do">
	<input type="hidden" name="courtTipOffIdx" value="${courtTipOffIdx}"/>
		<table>
			<tr>
				<th>경기장 이름</th>
				<th><input type="text" name="courtName" value="${courtTipOffInfo.courtName}" required/></th>
			</tr>
			<tr>
				<th>실내/외</th>
				<th>
			...
			<tr>
				<th>경기장 주소</th>
				<th><input type="text" name="courtAddress" value="${courtTipOffInfo.courtAddress}" required/></th>
			</tr>
		</table>
		<button>전송</button>
	</form>
